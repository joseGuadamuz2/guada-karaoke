/**
 * Íconos de redes sociales como SVG custom.
 * Lucide-React no incluye TikTok ni WhatsApp, por eso van inline.
 */
...
/**
 * Resuelve el componente de ícono por nombre de string.
 * @param {string} iconName
 * @param {number} size
 * @param {string} className
 */
export function SocialIcon({ iconName, size = 20, className = '' }) {
  const icons = { Facebook: FacebookIcon, TikTok: TikTokIcon, YouTube: YouTubeIcon, WhatsApp: WhatsAppIcon };
